						...
						<form method="POST">
							<div>
								...
								<ul class="actions special">
									...
									<a href="instructors" class="button">Reload</a>
								</ul>
							</div>
							<?php
							...
							<table>
								<thead>
									<tr>
										<td>Instructor's ID</td>
										<td>Instructor's Name</td>
										<td>Instructor's Email</td>
										<td></td>
									</tr>
								</thead>
								<tbody>
								<?php
									...
									$query = $pdo->prepare("SELECT * FROM instructor_list WHERE instructor_name LIKE '%$keyword%' OR `instructor_id` LIKE '%$keyword%' OR instructor_email LIKE '%$keyword%'");
									$query->execute();
							...
							<?php if ($page > 1): ?>
								<a href="instructors?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
							<?php endif; ?>
							<?php echo "Page : $page"; ?>
							<?php if ($page*$records_per_page < $num_contacts): ?>
								<a href="instructors?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
							<?php endif; ?>
						</div>
						</form>
					</header>
